...
export const ISO_TOPICS: ISOTopic[] = [
  ...
  },
  {
    ...
    categoryZh: '夾具與金屬件',
    iconName: 'Sparkles',
    shortSummaryZh: '規範所有性能測試前之標準預裝配程序；鎖定型與滑動型施加順序相反：鎖定型先旋至 0.08~0.12 N·m 扭矩（螺紋咬合），再於維持該扭矩下施加 26.5~27.5 N 推力；滑動型先施加 26.5~27.5 N 推力，再於維持推力下以 ≤0.10 N·m 扭矩微旋 ≤90°。兩力同時維持 5~6 秒後釋放。',
