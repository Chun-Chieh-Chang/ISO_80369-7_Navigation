  ...
  return (
    <div className="space-y-6">
      ...
      <div className="neo-card rounded-2xl p-5 space-y-4">
        ...
        {/* Filter & Search */}
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 pt-3 border-t border-[var(--neo-border)]">
            ...
            {[
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-xl text-xs font-medium transition-all whitespace-nowrap shrink-0 min-h-[36px] flex items-center ${
                  filterType === f.id ? 'bg-blue-600 text-white shadow-xs font-bold' : 'neo-tray text-[var(--neo-muted)] hover:text-[var(--neo-text)]'
                }`}
              >
                {f.label}
              </button>
          ...
          <div className="flex items-center space-x-2">
            <div className="relative w-full sm:w-60">
              ...
              <input
                ...
                className="neo-input w-full pl-9 pr-3 py-2 rounded-xl text-xs transition-all"
              />
            </div>
          </div>
        </div>
      ...
      <div className="space-y-4 md:hidden">
          {filteredClauses.map((clause) => {
            ...
            return (
              <div
                key={clause.id}
                className="neo-card rounded-2xl p-4 sm:p-5 space-y-3 transition-all"
              >
                {/* Header */}
                <div className="flex items-start justify-between gap-2 border-b border-[var(--neo-border)] pb-2.5">
                  <div>
                    <div className="flex items-center space-x-2">
                      <span className="bg-blue-600 text-white font-mono font-bold text-xs px-2.5 py-0.5 rounded-md shadow-2xs">
                        {clause.id}
                      </span>
                      <span className="bg-[var(--neo-inset)] text-[var(--neo-text)] text-[12px] font-bold px-2 py-0.5 rounded-md">
                        {clause.categoryZh}
                      </span>
                    </div>
                ...
                <div className="grid grid-cols-2 gap-2 text-xs font-mono">
                  <div className="neo-tray p-2 rounded-xl">
                        ...
                        <div className="flex gap-1">
                          <button
                            ...
                            className={`px-2 py-1 rounded-lg text-[10px] font-medium transition-all cursor-pointer ${
                              selectedType64 === 'lock' ? 'bg-blue-600 text-white shadow-xs' : 'neo-tray text-[var(--neo-muted)]'
                            }`}
                          >
                          ...
                          <button
                            ...
                            className={`px-2 py-1 rounded-lg text-[10px] font-medium transition-all cursor-pointer ${
                              selectedType64 === 'slip' ? 'bg-cyan-600 text-white shadow-xs' : 'neo-tray text-[var(--neo-muted)]'
                            }`}
                          >
                ...
                {isExpanded && (
                  <div className="pt-2 border-t border-[var(--neo-border)]">
                    <div className="neo-tray p-3 rounded-2xl space-y-3">
                      ...
                      <div className="border border-[var(--neo-border)] rounded-xl overflow-hidden bg-[var(--neo-surface)]">
        ...
        <div className="neo-card rounded-2xl overflow-hidden hidden md:block">
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse text-[13px]">
              <thead>
              <tr className="bg-[var(--neo-inset)] border-b border-[var(--neo-border)] text-[var(--neo-muted)] font-bold uppercase tracking-wider">
              ...
              {filteredClauses.map((clause) => {
                ...
                return (
                  <React.Fragment key={clause.id}>
                    <tr
                      onClick={() => setExpandedClauseId(isExpanded ? null : clause.id)}
                      className={`cursor-pointer transition ${isExpanded ? 'bg-blue-50/70 border-l-4 border-l-blue-600' : 'hover:bg-[var(--neo-inset)]'}`}
                    >
                      <td className="py-3 px-4 font-bold font-mono text-center text-blue-700 bg-[var(--neo-inset)]/50">
                        {clause.id}
                      </td>
                      ...
                      <td className="py-3 px-4 text-[var(--neo-text)] leading-relaxed bg-[var(--neo-inset)]/30">
                        {clause.criteria}
                      </td>
                    ...
                    {isExpanded && (
                      <tr className="bg-[var(--neo-inset)]/90 border-b-2 border-blue-200">
                        <td colSpan={10} className="p-4 sm:p-6">
                          <div className="neo-card rounded-2xl p-4 sm:p-5 space-y-4">
