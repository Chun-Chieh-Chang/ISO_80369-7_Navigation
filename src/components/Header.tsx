...
export const Header: React.FC<HeaderProps> = ({ activeTab, setActiveTab }) => {
  ...
  return (
    <header className="bg-white/90 backdrop-blur-md border-b border-slate-200/80 sticky top-0 z-50 shadow-xs">
      <div className="max-w-[1920px] w-[96%] mx-auto px-3 sm:px-5 lg:px-8">
        <div className="flex flex-col lg:flex-row items-stretch lg:items-center justify-between py-3.5 gap-4">
          
          {/* Brand & Main Title */}
          <div className="flex items-center space-x-3.5">
            <div className="p-3 bg-gradient-to-br from-blue-600 to-indigo-700 text-white rounded-2xl shadow-md shadow-blue-600/20 shrink-0">
            ...
            <div>
              <div className="flex items-center space-x-2.5">
                ...
                <span className="bg-gradient-to-r from-blue-50 to-indigo-50 text-blue-800 text-[13px] font-bold px-3 py-0.5 rounded-full border border-blue-200/80 shrink-0 shadow-2xs">
                  雙標準對照版 v1.2
                </span>
              </div>
          ...
          <div className="flex items-center space-x-2 text-[13px] font-mono shrink-0">
            <div className="bg-slate-50/90 border border-slate-200 px-3.5 py-1.5 rounded-2xl flex items-center space-x-2.5 shadow-2xs">
        ...
        {/* Navigation Tabs Bar */}
        <div className="flex flex-wrap gap-2 pb-2.5 pt-1.5 border-t border-slate-100/80">
          {tabs.map((tab) => {
            const Icon = tab.icon;
            ...
            return (
              <button
                ...
                className={`flex items-center space-x-2 px-4 py-2 rounded-xl text-sm font-semibold transition-all whitespace-nowrap cursor-pointer ${
                  isActive
