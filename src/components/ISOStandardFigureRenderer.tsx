...
export const ISOStandardFigureRenderer: React.FC<ISOStandardFigureRendererProps> = ({
  ...
  return (
    <div className={`neo-card rounded-2xl overflow-hidden text-[var(--neo-text)] ${className}`}>
      {/* Fig.Header Bar */}
      <div className="bg-[var(--neo-inset)] border-b border-[var(--neo-border)] px-4 py-3 flex flex-wrap items-center justify-between gap-2 text-xs">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <button
            ...
            className="neo-tray text-[var(--neo-muted)] hover:text-[var(--neo-text)] text-xs px-2.5 py-1 rounded-lg font-medium transition flex items-center gap-1.5 cursor-pointer"
          >
      ...
      <div className="p-4 sm:p-6 flex flex-col items-center justify-center bg-[var(--neo-surface)]/80 relative min-h-[360px]">
        ...
        <div className="mt-4 w-full neo-tray p-3.5 rounded-xl text-xs space-y-1">
          <div className="flex items-center justify-between text-[var(--neo-muted)] text-xs">
      ...
      {showCategoryModal && (
        <div className="fixed inset-0 z-50 bg-black/70 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="neo-card rounded-2xl max-w-xl w-full p-6 space-y-4 shadow-2xl relative text-[var(--neo-text)]">
            <div className="flex items-center justify-between pb-3 border-b border-[var(--neo-border)]">
              ...
              <button 
                ...
                className="text-[var(--neo-muted)] hover:text-[var(--neo-text)] p-1 rounded-lg hover:bg-[var(--neo-inset)] transition cursor-pointer"
              >
                <X className="w-5 h-5" />
              </button>
            </div>
            ...
            <div className="space-y-3 text-xs text-slate-600">
              ...
              <div className="space-y-2 max-h-[220px] overflow-y-auto pr-1">
                <div className={`p-2.5 rounded-xl border transition ${effectiveFigureType.includes('Testing Rig') || figureTypeZh.includes('測試裝置') ? 'bg-blue-50 border-blue-300 ring-1 ring-blue-300/60' : 'bg-[var(--neo-inset)] border-[var(--neo-border)] opacity-70'}`}>
                ...
                <div className={`p-2.5 rounded-xl border transition ${effectiveFigureType.includes('CAD') || figureTypeZh.includes('CAD') || figureTypeZh.includes('幾何') ? 'bg-blue-50 border-blue-300 ring-1 ring-blue-300/60' : 'bg-[var(--neo-inset)] border-[var(--neo-border)] opacity-70'}`}>
                  <div className="font-bold text-blue-700 flex items-center justify-between mb-0.5">
                ...
                <div className={`p-2.5 rounded-xl border transition ${effectiveFigureType.includes('Reference Fixture') || figureTypeZh.includes('夾具') || figureTypeZh.includes('參考') ? 'bg-amber-50 border-amber-300 ring-1 ring-amber-300/60' : 'bg-[var(--neo-inset)] border-[var(--neo-border)] opacity-70'}`}>
                ...
                <div className={`p-2.5 rounded-xl border transition ${effectiveFigureType.includes('Mechanism') || figureTypeZh.includes('機構') || figureTypeZh.includes('防誤插') ? 'bg-emerald-50 border-emerald-300 ring-1 ring-emerald-300/60' : 'bg-[var(--neo-inset)] border-[var(--neo-border)] opacity-70'}`}>
